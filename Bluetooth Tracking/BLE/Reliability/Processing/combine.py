...
with open ('I:\\Other computers\\My MacBook Air\\BLE_Reliability\\Results\\Nano.txt', 'r') as myfile1: # Open lorem.txt for reading text data.  #I:\Other computers\My MacBook Air\2_CBT_DEVICES\Processing\StudyCenter
...
with open ('I:\\Other computers\\My MacBook Air\\BLE_Reliability\\Results\\Esp32.txt', 'r') as myfile2: 
...
ti_cks = [1.5, 3.5, 5.5, 7.5, 9.5, 11.5, 13.5, 15.5, 17.5, 19.5, 21.5] 
...
custom_lines = [Line2D([0], [0],marker='o', color='w',markerfacecolor='dodgerblue', markersize=22),
                Line2D([0], [0],marker='o', color='w',markerfacecolor='orangered', markersize=22),
                Line2D([0], [0],marker='o', color='w',markerfacecolor='gray', markersize=22),
                Line2D([0], [0],marker='o', color='w',markerfacecolor='darkgreen', markersize=22)]
first_legend = plt.legend(custom_lines,['Random BLE device detected by Arduino Nano system','Random BLE device detected by ESP32 system','ESP32 advertising BLE','Vizia Airtag (BLE advertising Smart tracker)'],loc='best',prop={'size': 15},fontsize=15)
...
#plt.legend(handles=[solid,dashed],   loc='upper center',prop={'size': 15},fontsize=15)
plt.legend(handles=[solid,dashed],bbox_to_anchor=(0.65,0.5),prop={'size': 15},fontsize=15)
plt.xticks(fontsize=15)
plt.yticks(fontsize=12)
plt.xlabel('Time', fontweight ='bold', fontsize = 25)
plt.ylabel('Devices found', fontweight ='bold', fontsize = 25)
plt.title("Arduino Nano & ESP32 Tracking Bluetooth Low Energy Devices: 1", fontweight = 'bold', fontsize = 30)
plt.show()