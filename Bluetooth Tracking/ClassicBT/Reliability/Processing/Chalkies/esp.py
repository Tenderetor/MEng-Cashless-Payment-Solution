...
with open ('I:\\Other computers\\My MacBook Air\\2_CBT_DEVICES\\Processing\\Chalkies\\Chalkboard_Esp.txt', 'r') as myfile: # Open lorem.txt for reading text data.
...
plt.title("ESP32 At Engineering Student Cafe Public Location", fontweight = 'bold', fontsize = 40)
plt.show()