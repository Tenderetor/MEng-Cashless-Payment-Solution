...
with open ('Neelsie_Arduino.txt', 'r') as myfile: # Open lorem.txt for reading text data.
...
plt.title("HC-05 At Neelsie Student Center Public Location", fontweight = 'bold', fontsize = 15)
plt.show()