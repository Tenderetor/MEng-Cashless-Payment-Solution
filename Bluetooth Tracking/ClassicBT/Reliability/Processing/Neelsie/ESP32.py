...
with open ('Neelsie_Esp.txt', 'r') as myfile: # Open lorem.txt for reading text data.
...
plt.title("ESP32 At Neelsie Student Center Public Location", fontweight = 'bold', fontsize = 15)
plt.show()