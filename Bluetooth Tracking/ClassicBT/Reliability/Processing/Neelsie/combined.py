...
with open ('I:\\Other computers\\My MacBook Air\\2_CBT_DEVICES\\Processing\\Neelsie\\Neelsie_Arduino.txt', 'r') as myfile1: # Open lorem.txt for reading text data.  #I:\Other computers\My MacBook Air\2_CBT_DEVICES\Processing\StudyCenter
...
with open ('I:\\Other computers\\My MacBook Air\\2_CBT_DEVICES\\Processing\\Neelsie\\Neelsie_Esp.txt', 'r') as myfile2: 
...
ti_cks = [1.5, 3.5, 5.5, 7.5, 9.5, 11.5, 13.5, 15.5, 17.5, 19.5, 21.5, 23.5, 25.5, 27.5, 29.5, 31.5] 
...
#first_legend = plt.legend(custom_lines,['HC05 detected device','ESP32 detected device','Control device'],bbox_to_anchor=(0.1,0.82),loc='lower left',fontsize = 15)
first_legend = plt.legend(custom_lines,['HC05 detected device','ESP32 detected device','Control device'],loc='best',fontsize = 15)
...
#plt.legend(handles=[solid,dashed],  bbox_to_anchor=(0.1,0.92), loc='lower left',fontsize = 20)
plt.legend(handles=[solid,dashed], bbox_to_anchor=(0.6,1),fontsize = 15)

plt.xticks(fontsize=15)
plt.yticks(fontsize=12)
plt.xlabel('Time', fontweight ='bold', fontsize = 30)
plt.ylabel('Devices found', fontweight ='bold', fontsize = 30)
plt.title("HC-05 & ESP32 At Neelsie Student Center", fontweight = 'bold', fontsize = 35)
plt.show()