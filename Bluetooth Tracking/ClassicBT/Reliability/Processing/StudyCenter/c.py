...
custom_lines = [Line2D([0], [0],marker='o', color='w',markerfacecolor='dodgerblue', markersize=15),
...
first_legend = plt.legend(custom_lines,['HC05 detected device','ESP32 detected device','Control device (ESP32 in classic BT mode)'],bbox_to_anchor=(0.02,0.6),loc='lower left')
...
plt.legend(handles=[solid,dashed],  bbox_to_anchor=(0.02,0.8), loc='upper left')
plt.xlabel('Time', fontweight ='bold', fontsize = 15)
plt.ylabel('Devices found', fontweight ='bold', fontsize = 15)
plt.title("HC-05 & ESP32 At Engineering Study Center Public Location", fontweight = 'bold', fontsize = 15)
plt.show()