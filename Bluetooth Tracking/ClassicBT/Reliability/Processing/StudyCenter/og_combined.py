...
for (i_hc_mac,i_esp_mac) in itertools.zip_longest(sorted_hc_macs, sorted_esp_macs):
    if(count1 <= 9): #hard coding because the hc05 picked 10 macs 
...
ti_cks = [1.5, 3.5, 5.5, 7.5, 9.5, 11.5, 13.5, 15.5, 17.5] 
...
first_legend = plt.legend(custom_lines,['HC05 detected device','ESP32 detected device','Control device (ESP32 in classic BT mode)'],bbox_to_anchor=(0.02,0.55),loc='lower left',fontsize = 15)
...
plt.legend(handles=[solid,dashed],  bbox_to_anchor=(0.02,0.8), loc='upper left',fontsize = 15)

plt.xticks(fontsize=15)
plt.yticks(fontsize=12)
plt.xlabel('Time', fontweight ='bold', fontsize = 30)
plt.ylabel('Devices found', fontweight ='bold', fontsize = 30)
plt.title("HC-05 & ESP32 At Engineering Study Center", fontweight = 'bold', fontsize = 35)
plt.show()