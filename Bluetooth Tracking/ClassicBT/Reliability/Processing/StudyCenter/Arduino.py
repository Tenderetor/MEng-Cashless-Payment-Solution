...
with open ('I:\\Other computers\\My MacBook Air\\2_CBT_DEVICES\\Processing\\StudyCenter\\SS_Arduino.txt', 'r') as myfile: # Open lorem.txt for reading text data.  #I:\Other computers\My MacBook Air\2_CBT_DEVICES\Processing\StudyCenter
...
plt.title("HC-05 At Engineering Study Center Public Location", fontweight = 'bold', fontsize = 15)
plt.show()